...
<div style="max-width:600px;margin:0 auto;overflow:hidden;border:solid 2px #000;font-family: 'Century Gothic', CenturyGothic, arial, sans-serif">
    ...
    <div style="padding:16px;background-color:#f2f0f3;border-top-style:none;">
        ...
        <p>
            For Recover your password please click button below
        </p>
        <p>
            <br/>
        </p>
        <div class='areaclick' style="font-size:14px;font-weight:bold;text-align:center">
            <a style='font-size:32px;text-decoration:none;background-color:#FF0097;width:80%;margin:0 auto;display:block;color:#fff; padding:10px;border:solid 1px #000;' href="<?php echo base_url() . 'index.php/tools/recoverdirectly?email=' . $model['email'] . '&&activation=' . $model['activation'] ?>">Recover Your Password</a></div><br><div>
        </div>
        <p>
...
URL : <br/> <?php echo base_url() . 'index.php/user/forgot#konfirmation_email' ?> <br/>
...
Activation Code :<br/> <?php echo $model['activation'] ?>
    ...
    <div style="padding:10px;text-align:center;font-family:helvetica, sans-serif, arial;font-size:11px;color:#999999;" >
        Copyright © 2015,The Paper Stone. To unsubscribe click <a rel="noreferrer" target="_blank" href="<?php echo base_url() . 'index.php/tools/unsuscribe?email=' . $model['email'] . '&&usc=' . sha1($model['email']) ?>" style="color:#990000;" >here</a>.</div>
</div>